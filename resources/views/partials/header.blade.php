                            ...
                            <div class="dropdown-menu st-megamenu">
                                <div class="st-mega-grid">
                                    <div class="st-mega-col">
                                        ...
                                        <a class="dropdown-item st-mega-link" href="#">Dubai Luxe Getaways</a>
                                        <a class="dropdown-item st-mega-link" href="#">Thailand Beach Journeys</a>
                                        <a class="dropdown-item st-mega-link" href="#">Bali Island Escape</a>
                                        <a class="dropdown-item st-mega-link" href="#">Singapore Family Fun</a>
                                    </div>
                                    <div class="st-mega-col">
                                        <p class="st-mega-title">Premium Journeys</p>
                                        <a class="dropdown-item st-mega-link" href="#">Europe Signature Circuits</a>
                                        <a class="dropdown-item st-mega-link" href="#">Swiss Alpine Luxury</a>
                                        <a class="dropdown-item st-mega-link" href="#">Japan Seasonal Trails</a>
                                        <a class="dropdown-item st-mega-link" href="#">Turkey and Greece</a>
                                    </div>
                                    <div class="st-mega-col">
                                        <p class="st-mega-title">Travel Help</p>
                                        <a class="dropdown-item st-mega-link" href="#">Visa Assistance</a>
                                        <a class="dropdown-item st-mega-link" href="#">Group Departures</a>
                                        <a class="dropdown-item st-mega-link" href="#">Fixed Departure Dates</a>
                                        <a class="dropdown-item st-mega-link" href="#">View All International Tours</a>
                                    </div>
                                </div>
                            </div>
                        </li>
