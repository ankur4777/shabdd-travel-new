...
@section('content')
    <div class="beach-page"
        ...
        <section class="beach-faq" aria-label="{{ $faq_section['title'] ?? 'Frequently asked questions' }}">
            <div class="container">
                <div class="beach-section-head">
                    <span class="beach-eyebrow beach-eyebrow--dark">{{ $faq_section['eyebrow'] ?? 'FAQs' }}</span>
                    <h2>{{ $faq_section['title'] ?? 'Quick answers before you book' }}</h2>
