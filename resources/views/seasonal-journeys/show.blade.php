                ...
                <main class="seo-dd-main" itemscope itemtype="https://schema.org/Trip">
                    ...
                    <section id="faq" class="seo-dd-section" itemscope itemtype="https://schema.org/FAQPage">
                        <div class="seo-dd-title-wrap">
                            ...
                            <h2 class="seo-dd-title">Questions About {{ $journey->title }}</h2>
                        </div>
                        <div class="seo-dd-faq-list">
                            @foreach($faqs as $faq)
                                <article class="seo-dd-faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                                    <button type="button" class="seo-dd-faq-btn {{ $loop->first ? 'is-open' : '' }}" data-seasonal-faq-toggle>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('[data-seasonal-faq-toggle]').forEach(function (toggle) {
                toggle.addEventListener('click', function () {
                    ...
                    document.querySelectorAll('[data-seasonal-faq-toggle]').forEach(function (btn) {
                        btn.classList.remove('is-open');
                    });
                    document.querySelectorAll('.seasonal-detail-page .seo-dd-faq-panel').forEach(function (item) {
